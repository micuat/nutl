...
S070.prototype = Object.create(SRendererShadow.prototype);

S070.prototype.drawScene = function (pg, isShadow) {
  let p = this.p;
  let t = this.t;
  ...
  pg.pushMatrix();
  // for(let i in p.leap.getHands()) {
  //   print(i)
  //   let hand = p.leap.getHands()[i];
  //   for(let j in hand.getFingers()) {
  //     let finger = hand.getFingers()[j];
  //     let pos = finger.getPosition();
...
S070.prototype.constructor = S070;
